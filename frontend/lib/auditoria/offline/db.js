...
//   cola_audios  → notas de voz offline pendientes de transcribir (clave: client_op_id)
...
export function getDB() {
  return openDB(DB_NAME, DB_VERSION, {
    upgrade(db) {
      ...
      if (!db.objectStoreNames.contains('cola_audios')) {
        db.createObjectStore('cola_audios', { keyPath: 'client_op_id' })
      }
